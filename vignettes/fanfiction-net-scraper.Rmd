...
### 4. Update Repository of Story Tags

This package uses a pre-scraped list of href tags from the fanfiction.net media pages to get information about stories or the stories themselves. If you feel that the fandom you are looking for is missing due to it being very recent (after 2018), use the \code{updateTypeMedia} function.
